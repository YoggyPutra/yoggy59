"""
Django settings for yoggyproject191059 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-tax(gm1bg+a3!ipx0_x5-j&q*-7g*+vex(w&=wakac47ulf#h3')
...
ROOT_URLCONF = 'yoggyproject191059.urls'
...
WSGI_APPLICATION = 'yoggyproject191059.wsgi.application'
